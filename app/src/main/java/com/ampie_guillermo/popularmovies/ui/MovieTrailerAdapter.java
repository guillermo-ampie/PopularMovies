...
public class MovieTrailerAdapter extends RecyclerView.Adapter<MovieTrailerAdapter.TrailerViewHolder> {
    ...
    private final MovieTrailerList mMovieTrailerList;

    public MovieTrailerAdapter(MovieTrailerList movieTrailerList) {
...
//        Log.i(LOG_TAG, thumbnailUri.toString());
    ...
    public TrailerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.trailer_thumbnail_item, parent, false);
    ...
    public int getItemCount() {
        return mMovieTrailerList.getTrailerList().size();
    }
    ...
    static class TrailerViewHolder extends RecyclerView.ViewHolder {
        ...
        TrailerViewHolder(View view) {
            super(view);
            mTrailerThumbnailView = view.findViewById(R.id.trailer_thumbnail_view);
        }
    }
}
