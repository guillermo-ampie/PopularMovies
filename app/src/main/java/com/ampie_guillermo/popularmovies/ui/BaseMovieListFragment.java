...
public class BaseMovieListFragment
    extends Fragment
    implements MovieAdapter.MovieItemClickListener {
...
//
    /**
     * The RecyclerView's Adapter will take data from a a JSON response from TheMovieDB.org
     * server / local DB
     */
...
//    final Movie currentMovie = mMovieList.get(clickedItemIndex);
  ...
  public static class FavouriteMovieListFragment
      extends BaseMovieListFragment
      implements FetchMoviesListener {
    ...
    public void setupRecyclerViewAdapter() {
      // Set an empty adapter because the movies have not been fetched yet
//      mMovieAdapter = new FavouriteMovieAdapter(this);
//      mRvMovieGrid.setAdapter(mMovieAdapter);
      assert 1 != 1;
    }
