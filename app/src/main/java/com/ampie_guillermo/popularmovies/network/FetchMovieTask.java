...
public class FetchMovieTask extends AsyncTask<String, Void, Movie[]> {
  ...
  protected Movie[] doInBackground(String... params) {
    ...
    try {
      ...
      if (inputStream == null) {
        // Oops, we got nothing.
        Log.e(LOG_TAG, mContext.getString(R.string.error_empty_response));
        return null;
      }
      ...
      Log.e(LOG_TAG, mContext.getString(R.string.error_contacting_server), e);
      ...
      if (reader != null) {
        try {
          ...
          Log.e(LOG_TAG, mContext.getString(R.string.error_closing_stream), e);
        }
      }
    }
    ...
    Log.e(LOG_TAG, mContext.getString(R.string.error_contacting_server));
    return null;
  }
